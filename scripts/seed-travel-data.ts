...
import { Travel, TravelTip, EmergencyContact } from '@/models'
...
async function seedTravelData() {
  try {
    ...
    const travelData = [
      {
        ...
        location: {
          type: "Point",
          coordinates: [88.4467, 22.6547] // Kolkata airport coordinates
        },
        category: "Transport",
        transportType: "air",
        from: "Various Cities",
      ...
      },
      {
        ...
        location: {
          type: "Point",
          coordinates: [88.3426, 22.5836] // Howrah station coordinates
        },
        category: "Transport",
        transportType: "train",
      ...
      },
      {
        ...
        location: {
          type: "Point",
          coordinates: [88.3684, 22.5660] // Sealdah station coordinates
        },
        category: "Transport",
        transportType: "train",
      ...
      },
      {
        ...
        location: {
          type: "Point",
          coordinates: [88.3639, 22.5726] // Central Kolkata coordinates
        },
        category: "Transport",
        transportType: "bus",
        from: "Any Location",
    ...
    await Travel.insertMany(travelData)
    ...
    await TravelTip.insertMany(travelTipsData)
